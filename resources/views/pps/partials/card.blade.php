        ...
        <div class="card-body">
            <div class="mt-2">
                <span class="px-2 bg-teal-300 rounded-full shadow text-teal-600 uppercase tracking-wide font-semibold">
                    {{__($professionalPractice->status)}}
                </span>
            </div>
            <div class="mt-4">
                Fecha de inicio:
                <span class="text-gray-700 uppercase font-semibold tracking-wide">{{$professionalPractice->created_at->format('d/m/Y')}}</span>
            </div>
            <div class="mt-2">
                Tutor:
                <span class="text-gray-700 uppercase font-semibold tracking-wide">{{$professionalPractice->tutor->name}}</span>
            </div>
            <div class="mt-2">
